<div x-data="{ open: false }" x-cloak @open-notspam-modal.window="open = true" @keydown.escape.window="open = false"
    @idea-marked-notspam="open= false" class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div x-transition.origin.bottom.duration.500ms x-show="open" class="fixed inset-0 z-10 overflow-y-autp">
        ...
        <div class="flex min-h-full items-center justify-center">
            <div @click.away="open = false"
                ...
                <form wire:submit="resetSpamCounter" class="space-y-4 mt-6 mb-2">
                    <div class="flex space-x-3 px-6">
                        ...
                        <div class="pb-2 ">
                            <h3 class="text-xl font-semibold mb-1">Reset Spam Counter</h3>
                            <p>Are you sure you want to mark this idea as not spam? This will reset spam counter to 0.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex space-x-3 bg-gray-100 justify-end py-2 px-6">
                        ...
                        <button type="submit"
                            class="py-2 px-4 bg-blue hover:bg-blue-700 text-white rounded-lg font-semibold border border-gray-700 disabled:opacity-50">Reset
                            Spam Counter</button>
                    </div>

<div x-data="{ open: false }" x-cloak @open-delete-modal.window="open = true" @keydown.escape.window="open = false"
    ...
    <div x-transition.origin.bottom.duration.500ms x-show="open" class="fixed inset-0 z-10 overflow-y-autp">
        ...
        <div class="flex min-h-full items-center justify-center">
            <div @click.away="open = false"
                ...
                <form wire:submit="deleteIdea" class="space-y-4 mt-6 mb-2">
                    <div class="flex space-x-3 px-6">
                        ...
                        <div class="pb-2 ">
                            <h3 class="text-xl font-semibold mb-1">Delete Idea</h3>
                    ...
                    <div class="flex space-x-3 bg-gray-100 justify-end py-2 px-6">
                        ...
                        <button type="submit"
                            class="py-2 px-4 bg-red-600 hover:bg-red-700 text-white rounded-lg font-semibold border border-gray-700 disabled:opacity-50">Delete</button>
                    </div>

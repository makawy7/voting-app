<x-app-layout>
    ...
    <div class=" ideas-container my-6 space-y-6">
        <div
            class="idea-container hover:shadow-lg transition ease-in duration-150 bg-white px-4 sm:px-0 rounded-xl flex">
            ...
            <div class="flex flex-col sm:flex-row flex-1 px-2 py-6">
                ...
                <div class="sm:mx-4 w-full">
                    ...
                    <p class="mt-3 text-gray-600 line-clamp-3 max-w-sm sm:max-w-none">Lorem ipsum dolor sit amet
